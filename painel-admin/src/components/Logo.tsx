...
export function Logo({ tamanho = 24, corTraco = '#F5F5F3', corAcento = '#0FBFA0' }: LogoProps) {
  ...
  return (
    <svg width={tamanho} height={tamanho} viewBox="0 0 48 48" fill="none">
      ...
      />
      <path d="M16.5 20.5 L23.5 30.5" stroke={corAcento} strokeWidth={hastes} strokeLinecap="round" />
      <path d="M32.5 15 L19.5 30.5" stroke={corAcento} strokeWidth={hastes} strokeLinecap="round" />
